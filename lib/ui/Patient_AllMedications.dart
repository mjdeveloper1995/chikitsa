...
class Patient_AllMedications extends StatefulWidget {
  @override
  _Patient_AllMedicationsState createState() => _Patient_AllMedicationsState();
}

class _Patient_AllMedicationsState extends State<Patient_AllMedications> {
