...
class PatientDetails extends StatefulWidget {
  PatientDetails(
      {this.id, this.name, this.mobile, this.email, this.age, this.address});
...
class _PatientDetailsState extends State<PatientDetails> {
  ...
  Future<void> onSubmitNotification(String message) async {
    ...
    try {
      ...
      formData['sentBy'] = 'Doctor';
      formData['patientId'] = widget.id;
      formData['doctorId'] = StringConstant.userId;

      final response = await DoctorService.addNotification(formData);
      setState(() {
        _isLoading = false;
      });
