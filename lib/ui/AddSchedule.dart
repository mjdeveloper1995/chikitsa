import 'package:chikitsa/podo/Weekname.dart';
...
class _AddScheduleState extends State<AddSchedule> {
  ...
  String select;
  String textHolder = "Select time";
  String valueRadio;
  String _scheduleRadioBtnVal;
  String morning = "07:15 AM";
      ...
      children: [
        Container(
          ...
          child: Text(
            'Select ' +
                '$textHolder' +
                ' in a Weekly and set their time of Medicine :',
            style: TextStyle(
              letterSpacing: 1.0,
              fontWeight: FontWeight.normal,
              fontFamily: 'Lato-Regular',
...
class _scheduleRadioBtnValContainer {}
